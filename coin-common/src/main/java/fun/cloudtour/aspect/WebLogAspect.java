package fun.cloudtour.aspect;

import cn.hutool.core.util.StrUtil;
import cn.hutool.core.util.URLUtil;
import com.alibaba.fastjson.JSON;
import fun.cloudtour.model.WebLog;
import fun.cloudtour.util.IpUtil;
 ...
 * @author cloudtour
 * @version 1.0
 * @description web日志记录（用于logstash）
...
public class WebLogAspect {
     ...
     * 1 定义切入点
     */
    @Pointcut("execution(* fun.cloudtour.controller.*.*(..))") // controller 包里面所有类，类里面的所有方法 都有该切面
    public void webLog(){}
    ...
    public Object recodeWebLog(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        webLog.setMethod(targetClassName+"."+method.getName()); // fun.cloudtour.controller.UserController.login()
