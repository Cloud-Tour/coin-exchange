...
import fun.cloudtour.domain.CashWithdrawals;
import fun.cloudtour.model.CashSellParam;
import fun.cloudtour.model.R;
import fun.cloudtour.service.CashWithdrawalsService;
import fun.cloudtour.util.ReportCsvUtils;
...
public class CashWithdrawalsController {
    ...
    @GetMapping("/records/exportCNYWithDrawals")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "userId", value = "用户的ID"),
            @ApiImplicitParam(name = "userName", value = "用户的名称"),
            @ApiImplicitParam(name = "mobile", value = "用户的手机号"),
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "CashWithdrawAuditRecord" ,value = "现金的提现审核")
    })
